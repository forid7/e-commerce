...
<html lang="en">
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Archtic Spark</a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{route('today.delivered')}}" class="nav-link">Today Delivered</a></li>
      ...
      <li class="nav-item"><a href="{{route('create.admin')}}" class="nav-link">create user</a></li> 
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('admin.newslater')}}" class="nav-link">New Message</a></li>
          <li class="nav-item"><a href="{{route('admin.seo')}}" class="nav-link">All Message</a></li>
        </ul>
         @else
        @endif
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('admin.newslater')}}" class="nav-link">New Comment</a></li>
          <li class="nav-item"><a href="{{route('admin.seo')}}" class="nav-link">All Comment</a></li>
        ...
        <li class="nav-item"><a href="{{route('admin.site.setting')}}" class="nav-link">Site Setting</a>
         ...
         <li class="nav-item"><a href="" class="nav-link">Database Backup</a>
        </li>
        ...
        <nav class="nav">
          ...
          <div class="dropdown">
            ...
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <a href="{{route('user.panel')}}">User Panel</a>
