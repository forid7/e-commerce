        ...
        <div class="card pd-20 pd-sm-40">
          ...
          <div class="table-wrapper">
			  ...
			  <div class="form-group">			  	
			    ...
			    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"  name="brand_name" required="">
			  </div>
               <div class="form-group">			  	
			  ...
			  <div class="form-group">			  	
			    ...
			    <img src="{{URL::to($brand->brand_logo)}}" style="height: 70 px; width: 90px;" >
