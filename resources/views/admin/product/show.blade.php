       ...
       <div class="card pd-20 pd-sm-40">
          ...
          <p class="mg-b-20 mg-sm-b-30">Product Details</p>
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-12" style="border: 1px solid grey; padding:10px;">
              	<div class="form-group">
              ...
              <div class="col-lg-4">
              	<lebel>Image Two (Main Thumbnail)<span class="tx-danger">*</span></lebel>
              	<label class="custom-file">
              	<br>
              ...
              <div class="col-lg-4">
              	<lebel>Image three (Main Thumbnail)<span class="tx-danger">*</span></lebel>
              	<label class="custom-file">
              		<br>
