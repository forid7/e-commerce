		       ...
		       <div class="card pd-20 pd-sm-40">
                ...
                <form action="{{url('update/product/photo/'.$product->id)}}" method="post" enctype="multipart/form-data">
				  ...
				  <img src="#" id="one">
                  	...
                  	<div class="col-lg-6 col-sm-4">
                  		<img src="{{URL::to($product->image_one)}}" style="height: 80px; width: 100px;">
                  	</div>
                 ...
                 <div class="row">
				  ...
				  <img src="#" id="two" >
                  	...
                  	<div class="col-lg-6 col-sm-4">
                  		<img src="{{URL::to($product->image_two)}}" style="height: 80px; width: 100px;">
                  	</div>
				...
				<input type="hidden" name="old_three" value="{{$product->image_three}}">
				  ...
				  <img src="#" id="three" >
                  	...
                  	<div class="col-lg-6 col-sm-4">
                  		<img src="{{URL::to($product->image_three)}}" style="height: 80px; width: 100px;">
                  	</div>
