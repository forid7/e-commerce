...
<div class="d-flex align-items-center justify-content-center bg-sl-primary ht-100v">
      ...
      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white">
        <div class="signin-logo tx-center tx-24 tx-bold tx-inverse">ONE  <span class="tx-info tx-normal">TECH</span></div>
        <div class="tx-center mg-b-60">E-Commerce Project</div>

        <div>
          <a href="{{URL::to('/')}}">User Panel</a>
        </div>
