...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js"></script>
                            ...
                            <div class="top_bar_content ml-auto">
                                ...
                                <div class="top_bar_menu">
                                   ...
                                   {{-- @if (session_id() == 3) {
                                    ...
                                    <a href="{{URL::to('/admin')}}">Admin Panel link1</a>
                                   ...
                                   @else{
                                    <a href="{{URL::to('/admin/home')}}">Admin Panel link2</a>
                                    ...
                                    @endif --}}
                                       ...
                                       <a href="{{URL::to('/admin')}}">Admin Panel link1</a>
                                       <div><p>(first logout user account)</p></div>
                                ...
                                <div class="top_bar_menu">
                                 ...
                                 <div class="top_bar_menu">
                                    <ul class="standard_dropdown ">
                                       ...
                                       <li>
                                           <a href="#"  data-toggle="modal" data-target="#exampleModalLong">Track Order</a>
                                       </li>
                                ...
                                <div class="top_bar_user">
                                    ...
                                    @guest
                                    <div><a href="{{route('login')}}"><div class="user_icon"><img src="{{asset('public/frontend/images/user.svg')}}" alt="">
                                    </div>
                                    @if(session()->get('lang')=='bangla')
                                    রেজিস্টার/লগইন
                                    @else
                                ...
                                <div class="cart">
                                    <div class="cart_container d-flex flex-row align-items-center justify-content-end">
                                        ...
                                        <div class="cart_content">
                                            ...
                                            <div class="cart_text"><a href="{{route('show.cart')}}">Cart<p style="font-size: 13px;">(coupon applied)</p></a></div>@if(Cart::Subtotal()==0)
                                            @else
                                            <div class="order_total_amount">${{(Cart::Subtotal()+$charge+Cart::Subtotal()*.15)-Session::get('coupon')['discount']}}</div>
                                            @endif
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Your status code</h5>
    ...
    <script src="{{ asset('https://unpkg.com/sweetalert/dist/sweetalert.min.js')}}">
         ...
         $(document).on("click", "#return", function(e){
             ...
             var link = $(this).attr("href");
                swal({
                  ...
                  text: "Once Return, This will be Permanently Done!",
                  icon: "warning",
                  buttons: true,
                  dangerMode: true,
                })
