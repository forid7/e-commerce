            ...
            <div class="col d-flex flex-lg-row flex-column align-items-center justify-content-start">
                    ...
                    <div class="featured">
                        ...
                        @else
                            ...
                            <span class="text-danger" style="font-size: 100%"><b> ${{$row->discount_price}}</b> </span><span style="font-size: 80%">{{$row->selling_price}}</span>
...
@endphp
        ...
        <button id="{{$row->id}}" class="product_cart_button addcart" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)">Add to Cart</button>
                            ...
                            <br><br>
                             <div>
                            <button type="button" class="btn btn-primary btn-sm" id="{{$row->id}}" class="product_cart_button addcart" data-toggle="modal" data-target="#cartmodal" onclick="productview(this.id)">Add to cart</button>
                              </div>
                                        </div>
